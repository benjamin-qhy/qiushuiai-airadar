...
- [Button](https://www.assistant-ui.com/design/components/button): The pressable object: thin, flat, and 8px round, in every weight a surface needs.
- [Dropdown Menu](https://www.assistant-ui.com/design/components/dropdown-menu): Actions behind a trigger: items, shortcuts, and separators on a quiet surface.

### Inputs

- [Input](https://www.assistant-ui.com/design/components/input): A single-line field with a label, drawn with a hairline.
- [Select](https://www.assistant-ui.com/design/components/select): Pick one value from a list, with groups and sizes.
- [Combobox](https://www.assistant-ui.com/design/components/combobox): Type to filter, then pick: a select with a search field.
- [Switch](https://www.assistant-ui.com/design/components/switch): A binary control in two sizes; the only capsule in the kit.
- [Kbd](https://www.assistant-ui.com/design/components/kbd): Keyboard keys as printed caps, for shortcuts and hints.

### Display

- [Badge](https://www.assistant-ui.com/design/components/badge): A small label for status, categories, or metadata.
- [Avatar](https://www.assistant-ui.com/design/components/avatar): People as initials or images, alone or stacked in groups.
- [Skeleton](https://www.assistant-ui.com/design/components/skeleton): The loading shape of content that has a known layout.
- [Separator](https://www.assistant-ui.com/design/components/separator): A hairline between things, horizontal or vertical.
- [Number Roll](https://www.assistant-ui.com/design/components/number-roll): Numbers that roll to their next value instead of jumping.
- [Dot Matrix](https://www.assistant-ui.com/design/components/dot-matrix): A dot-grid indicator for connecting, running, and settled states.
- [Diff Viewer](https://www.assistant-ui.com/design/components/diff-viewer): Code changes as unified or split diffs, line by line.
- [Scrollbar](https://www.assistant-ui.com/design/components/scrollbar): A quiet overlay scrollbar for panes that keep their own scroll.
- [Callout](https://www.assistant-ui.com/design/components/callout): A quiet aside on a colored rule, for notes, warnings, and errors in prose.
- [Steps](https://www.assistant-ui.com/design/components/steps): A numbered rail for processes that happen in order.
- [Code Block](https://www.assistant-ui.com/design/components/code-block): Highlighted code on a field panel, with a title bar and a copy button.
- [Command Tabs](https://www.assistant-ui.com/design/components/command-tabs): One command in several dialects, with synced tabs and a copy button.
- [Table](https://www.assistant-ui.com/design/components/table): A print-register data table with hairline rules and mono headers.
- [Definition List](https://www.assistant-ui.com/design/components/definition-list): A spec sheet of terms and details, one hairline per row.

### Overlay

- [Dialog](https://www.assistant-ui.com/design/components/dialog): A modal sheet for decisions that need the page to wait.
- [Popover](https://www.assistant-ui.com/design/components/popover): Anchored detail on demand, dismissed by clicking away.
- [Tooltip](https://www.assistant-ui.com/design/components/tooltip): A short label that appears on hover and stays out of the way.
- [Sheet](https://www.assistant-ui.com/design/components/sheet): A panel that slides in from an edge for secondary flows.
- [Toast](https://www.assistant-ui.com/design/components/toast): A passing message for outcomes: success, error, and undo.

### Navigation

- [Tabs](https://www.assistant-ui.com/design/components/tabs): Switch between views without leaving the page.
- [Breadcrumb](https://www.assistant-ui.com/design/components/breadcrumb): Where you are, as a path you can walk back up.
- [Accordion](https://www.assistant-ui.com/design/components/accordion): Sections that expand one at a time, or all at once.
- [Collapsible](https://www.assistant-ui.com/design/components/collapsible): One region that folds open and closed in place.

## Discovery

- Design law: https://www.assistant-ui.com/design.md
- Component gallery: https://www.assistant-ui.com/design/components
- Component Markdown: https://www.assistant-ui.com/design/components/<name>.md
- Documentation skill: https://www.assistant-ui.com/skill.md
